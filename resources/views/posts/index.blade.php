...
@section('content')
    ...
    <a href="{{ route('posts.create') }}">Create Post</a>
        @foreach ($posts as $post)
            <li>
                <div
                    style="display: table; width: 100%; align-items: center; padding: 20px; margin-top: 20px; border: 1px solid #ccc;">
                    <img src="https://picsum.photos/200/150?random={{ $post->id }}" alt="Article Image" style="display: table-cell; width: 7.5rem; max-width: 7.5rem;">
                    <div style="display: table-cell; width: inherit; padding-left: inherit; vertical-align: middle">
                        ...
                        <div style="float: right; margin: 10px">
                            ...
                            <a style="display: inherit; font-size: 14px; margin-bottom: 10px; text-align: right">{{ $post->created_at->diffForHumans() }}</a>
                        </div>
                    </div>
                </div>
            </li>
